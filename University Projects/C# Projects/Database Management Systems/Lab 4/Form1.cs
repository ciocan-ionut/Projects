...
namespace Lab_4
{
    public partial class Form1 : Form
    {
        ...
        private void addIndexBtn_Click(object sender, EventArgs e)
        {
            ...
            context.Database.ExecuteSqlRaw("CREATE INDEX IF NOT EXISTS idx_employees_department_id ON \"Employees\" (\"DepartmentId\");");
            context.Database.ExecuteSqlRaw("CREATE INDEX IF NOT EXISTS idx_employees_salary ON \"Employees\" (\"Salary\");");
            context.Database.ExecuteSqlRaw("CREATE INDEX IF NOT EXISTS idx_employees_dept_salary ON \"Employees\" (\"DepartmentId\", \"Salary\");");
            isIndexPresent = true;
        }
        ...
        private void emailBtn_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                var result = context.Employees.Where(emp => emp.Email == "Kayla.Walter@gmail.com").ToList();
            }
            stopwatch.Stop();

            string plan = GetExplainAnalyze("SELECT * FROM \"Employees\" WHERE \"Email\" = 'Kayla.Walter@gmail.com'");
            expAnlRtb.Text = plan;
        ...
        private void dptBtn_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                var result = context.Employees.Where(emp => emp.DepartmentId == 5).ToList();
            }
            stopwatch.Stop();

            string plan = GetExplainAnalyze("SELECT * FROM \"Employees\" WHERE \"DepartmentId\" = 5");
            expAnlRtb.Text = plan;
        ...
        private void salaryBtn_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                var result = context.Employees.Where(emp => emp.Salary >= 50000 && emp.Salary <= 80000).ToList();
            }
            stopwatch.Stop();

            string plan = GetExplainAnalyze("SELECT * FROM \"Employees\" WHERE \"Salary\" >= 50000 AND \"Salary\" <= 80000");
            expAnlRtb.Text = plan;
        ...
        private void multiBtn_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                var result = context.Employees.Where(emp => emp.DepartmentId == 5 && emp.Salary > 60000).ToList();
            }
            stopwatch.Stop();

            string plan = GetExplainAnalyze("SELECT * FROM \"Employees\" WHERE \"DepartmentId\" = 5 AND \"Salary\" > 60000");
            expAnlRtb.Text = plan;
